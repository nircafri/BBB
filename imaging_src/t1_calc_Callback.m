function handles=t1_calc_Callback(hObject,handles)
...
% [Selection,ok] = listdlg('PromptString','Select angles to include:',...
%         'ListString',num2str(deg),'InitialValue',2:length(deg));
